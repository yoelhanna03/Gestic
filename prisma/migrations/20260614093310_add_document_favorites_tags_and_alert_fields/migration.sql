-- CreateEnum
CREATE TYPE "DocumentType" AS ENUM ('CONTRACT', 'INVOICE', 'INSURANCE', 'IDENTITY', 'TAX', 'OTHER');
...
-- AddForeignKey
ALTER TABLE "Alert" ADD CONSTRAINT "Alert_documentId_fkey" FOREIGN KEY ("documentId") REFERENCES "Document"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
