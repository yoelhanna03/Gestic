...
import { FaShieldAlt, FaFileContract, FaBell, FaUsers, FaCheckCircle } from 'react-icons/fa';
    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <nav className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto w-full">
        ...
        <div className="hidden md:flex items-center gap-6 text-sm font-medium">
          ...
          <Link href="/auth/signin" className="px-4 py-2 rounded-full bg-primary text-primary-foreground hover:opacity-90 transition-opacity">
            Se connecter
          </Link>
        </div>
      </nav>
      ...
      <header className="relative px-6 py-20 md:py-32 max-w-7xl mx-auto w-full text-center">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6">
            La sérénité pour vos <span className="text-primary">documents familiaux</span>
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed">
            Gestic centralise vos contrats, abonnements et papiers importants dans un coffre-fort numérique ultra-sécurisé.
            Ne ratez plus jamais une date de résiliation ou un renouvellement.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth/signup" className="px-8 py-4 rounded-lg bg-primary text-primary-foreground font-semibold text-lg hover:opacity-90 transition-opacity">
              Créer mon coffre-fort
            </Link>
            <Link href="#features" className="px-8 py-4 rounded-lg border border-border font-semibold text-lg hover:bg-accent transition-colors">
              En savoir plus
            </Link>
          </div>
        </div>
      ...
      <section id="features" className="px-6 py-20 bg-secondary/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Tout ce dont votre foyer a besoin</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Une plateforme conçue pour simplifier la gestion administrative du foyer et protéger vos données les plus précieuses.
            </p>
          </div>
      ...
      <section id="pricing" className="px-6 py-20 max-w-7xl mx-auto w-full">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Des tarifs adaptés à tous</h2>
          <p className="text-muted-foreground">Commencez gratuitement et passez au premium pour plus de stockage et de fonctionnalités.</p>
        </div>
